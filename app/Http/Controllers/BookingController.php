...
class BookingController extends Controller
{
    ...
    public function join(Request $request, $tripId)
    {
        ...
        $departureDatetime = $trip->departure_at instanceof \Carbon\CarbonInterface
    ...
    public function destroy($id)
    {
        ...
        $departure = $booking->trip->departure_at instanceof \Carbon\CarbonInterface
            ? $booking->trip->departure_at->copy()->timezone(config('app.timezone'))
            : Carbon::parse((string) $booking->trip->departure_at, config('app.timezone'));
